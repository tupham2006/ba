...
angular.module('ba').directive('genderSelect', function() {
	return {
		...
		template: "<select ng-class='{ \"disabled\" : ngDisabled }' ng-model='ngModel' class='form-control' convert-to-number><option value='0'>Chưa rõ</option><option value='1'>Nam</option><option value='2'>Nữ</option></select>"
	};
});