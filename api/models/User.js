...
module.exports = {
  ...
  attributes: {
    ...
    position_id : { type: "string", size: 11, defaultsTo: 1 },
    position_name : { type: "string", size: 50, maxLength: 50, defaultsTo: 'Chưa có chức vụ' },
    department_id : { type: "string", size: 11, defaultsTo: 1 },
    department_name : { type: "string", size: 50, maxLength: 50, defaultsTo: 'Chưa phân ban' },
